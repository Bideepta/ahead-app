        ...
        <Row>
          <Col md={6}>
            <Card.Body style={{ marginTop: 10 }}>
              <Card.Title
                style={{ fontSize: 40, paddingBottom: 20, fontWeight: "bold" }}
              >
                Work with us
              </Card.Title>
              <CardGroup>
                <div style={subCardStyle}>
                  <Card
                    style={{ padding: 20, border: "none", borderRadius: 20 }}
                  >
                    <Card.Body>
          ...
          <Col md={6}>
            <Card.Body style={{ marginLeft: 150, marginTop: 10 }}>
              ...
              />
              <div
                className="scrollable-container" onScroll={handleScroll}
              >
                <Card className="smallSubcard mb-4" style={cardStyle2}>
                  <Card.Body>
                ...
                <Card className="smallSubcard mb-4" style={cardStyle2}>
                  <Card.Body>
                    ...
                    <Card.Text style={{ fontSize: 12 }}>
                      We ask the right question to help you better understand
                ...
                <Card className="smallSubcard mb-4" style={cardStyle2}>
                  <Card.Body>
                    ...
                    <Card.Text style={{ fontSize: 12 }}>
                      Ahead feels like a game, not like a chore. See yourself
                      grow everday towards acheiving your goals!
                    </Card.Text>
                  </Card.Body>
                </Card>
                <Card className="smallSubcard mb-4" style={cardStyle2}>
                ...
                {showHiddenCard && (
                  <Card className="smallSubcard mb-2" style={cardStyle2}>
                    <Card.Body>
                      <Card.Title style={{ fontSize: 15 }}>
                        Play and grow together with others on the same journey
                      </Card.Title>
                      <Card.Text style={{ fontSize: 12 }}>
                        Ahead feels like a game, not like a chore. See yourself
                        grow every day towards achieving your goals!
                      </Card.Text>
                    </Card.Body>
                  </Card>
                )}
